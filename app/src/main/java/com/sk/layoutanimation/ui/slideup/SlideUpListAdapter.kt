...
class SlideUpListAdapter(private val movieList: List<MovieItem>?) : RecyclerView.Adapter<MovieItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MovieItemViewHolder, position: Int) {
        ...
        holder.itemView.animation = AnimationUtils.loadAnimation(holder.itemView.context, R.anim.slide_up)
